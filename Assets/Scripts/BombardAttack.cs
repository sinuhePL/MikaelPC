...
public class BombardAttack : Attack
{
    ...
    public BombardAttack(int aId, bool state, int army, Unit o, int keyField, bool isKFTaken, int tId, Vector3 p, string aType, string dType, bool isAimed) : base(aId, state, army, o, keyField, isKFTaken, tId, p)
    {
    ...
    public BombardAttack(int aId, bool state, int army, Unit o, int keyField, bool isKFTaken, int tId, Vector3 p, int aNum, int dNum, bool isAimed) : base(aId, state, army, o, keyField, isKFTaken, tId, p)
    {
        isTargetAimed = isAimed;
        if (isTargetAimed) attackName = "Bombard";
        else attackName = "Aim";
    ...
    {
        BombardAttack nca;
        nca = new BombardAttack(attackId, isActiveState, armyId, o, keyFieldId, isKeyFieldTaken, targetId, arrowPosition, attackDiceNumber, defenceDiceNumber, isTargetAimed);
